...
const emit = defineEmits(['showModalCover'])
...
const crop = () => {
    ...
    data.append('imageCover', fileInput.value.files[0] || '')
    data.append('height', coordinates.height || '')
    data.append('width', coordinates.width || '')
    data.append('left', coordinates.left || '')
    data.append('top', coordinates.top || '')

    router.post('/user/update-image-cover', data, {
        preserveState: false,
    })
            ...
            <div class="flex flex-col min-h-full justify-center items-center py-2">
                ...
                >
                    <div class="flex items-center py-4 border-b border-b-gray-300">
                        ...
                        <div
                            @click="$emit('showModalCover', false)"
                        ...
                        <div>
                            <div class="my-4">
                                ...
                                <label
                                    ...
                                    "
                                >
                                    <Plus :size="20"/> Buscar foto de capa
                                </label>
                                <input
                                    type="file"
                                    id="image"
