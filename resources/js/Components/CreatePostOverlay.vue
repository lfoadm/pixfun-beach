                ...
                <div class="border-t border-t-gray-300">
                    <div class="p-4">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="flex items-center justify-between w-[100px] bg-gray-200 p-0.5 px-2 rounded-lg">
                                    <Earth :size="18"/>
                                    <span class="font-bold pl-1.5 text-[13px]">Público</span>
                        ...
                        <div class="max-h-[350px] overflow-auto">
                            <textarea
                                v-model="form.text"
                                class="w-full border-0 mt-4 focus:ring-0 text-[18px] text-gray-600"
                                placeholder="Poste algo engraçado..."
                                cols="30"
                                rows="3"
                            ></textarea>
                        ...
                        <div class="border-2 rounded-xl mt-4 shadow-sm flex items-center justify-between">
                            <div class="font-extrabold p-4 text-gray-400">
                                Adicione imagem!
                            </div>
                            <div class="flex items-center">
                                ...
                                <label
                                    for="image"
                                    class="hover:bg-gray-200 rounded-full p-2 cursor-pointer mr-4"
                                >
                        ...
                        <button
                            @click="createPost"
                            class="w-full bg-orange-500 hover:bg-orange-600 text-white font-extrabold p-1.5 mt-3 rounded-lg"
                        >
                            Enviar
                        </button>
